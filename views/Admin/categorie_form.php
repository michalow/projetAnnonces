...
if(isset($_GET['id'])) {
    ...
    try {
        ...
        $categorie = $categoriesQuery->fetch(PDO::FETCH_ASSOC); //cette variable récupère les données selon id et sert à afficher dans formulaire prérempli (champ value)  
...
<div class='row'>
    <form method='post' action='categorie_edit.php'>
        ...
        <div class='form-group my-3'>
            ...
            <input type='text' name='nom' class='form-control' id='nom' placeholder='Enter nom' required autofocus value='<?= isset($categorie['nom_categorie']) ? htmlentities($categorie['nom_categorie']) : '' ?>'>
        </div>
        <div class='form-group my-3'>
